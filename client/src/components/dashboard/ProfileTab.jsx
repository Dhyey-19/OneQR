  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-2">
        <div className="w-20 h-20 rounded-3xl bg-gradient-to-tr from-blue-600 to-indigo-500 flex items-center justify-center text-white font-black text-2xl shadow-xl shadow-blue-550/20 mx-auto border-2 border-white/20 ">
          OQ
        </div>
      ...
      {/* Main Settings Card */}
      <div className="glass rounded-3xl p-6 sm:p-8 border border-slate-200/60  shadow-lg relative overflow-hidden space-y-6">
        ...
        <div className="flex items-center justify-between border-b border-slate-100  pb-4">
          <div className="space-y-0.5">
            ...
            <h3 className="font-extrabold text-lg text-slate-900  flex items-center gap-1.5 leading-none mt-1">
              Active Member
        ...
        <div className="space-y-1">
          {/* Phone Row */}
          <div className="flex items-center justify-between py-3.5 px-4 rounded-2xl hover:bg-slate-50/50  transition-colors border border-transparent hover:border-slate-100 ">
          ...
          <div className="flex items-center justify-between py-3.5 px-4 rounded-2xl hover:bg-slate-50/50  transition-colors border border-transparent hover:border-slate-100 ">
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="text-left overflow-hidden">
                ...
                <span className="text-slate-800  font-bold text-sm block mt-1 break-all">
        ...
        {isEditing && (
          <div className="fixed inset-0 z-[100] flex sm:items-center items-end justify-center px-0 sm:px-4 overflow-hidden">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md glass rounded-t-3xl sm:rounded-3xl p-6 sm:p-8 border-t sm:border border-slate-200  shadow-2xl overflow-y-auto z-10 max-h-[85vh] sm:max-h-none space-y-6"
            >
              ...
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-450 " />
                    <input
                      type="tel"
                      id="profile-phone"
                      value={phone}
                      ...
                      className="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-50  border border-slate-200  text-slate-900  placeholder-slate-400  text-sm focus:outline-none focus:border-blue-500/50 focus:bg-white  transition-all font-semibold"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-455 " />
                    <input
                      type="email"
                      id="profile-email"
                      value={email}
              ...
              <AnimatePresence>
                {status === "success" && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 10 }}
                    className="p-3.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 flex items-center gap-2.5 text-xs font-semibold text-emerald-600 "
                  >
                ...
                {status === "error" && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 10 }}
                    className="p-3.5 rounded-xl border border-rose-500/30 bg-rose-500/10 flex items-center gap-2.5 text-xs font-semibold text-rose-500 "
                  >
