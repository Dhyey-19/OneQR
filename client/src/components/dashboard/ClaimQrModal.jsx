...
export default function ClaimQrModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleQrClaim = async (inputVal) => {
    ...
    try {
      ...
      setClaimStatus("error");
      setClaimMessage(
        err.message || "An error occurred while claiming the QR code.",
      );
    }
  };
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="w-full max-w-md bg-white  border border-slate-200  rounded-3xl p-6 shadow-2xl relative overflow-hidden space-y-6"
          >
