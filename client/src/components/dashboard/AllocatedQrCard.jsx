    ...
    <>
      ...
      >
        ...
        <div className="w-full flex items-center justify-between gap-2">
          ...
          <span className={`px-2.5 py-1 rounded-full border text-[9px] font-bold ${
            isStandyConnected 
        ...
        <div className="w-full space-y-3">
          ...
          <button
            onClick={() => onManage(profile._id)}
            className="w-full py-2.5 px-3 rounded-lg bg-blue-650 hover:bg-blue-600 text-white text-[10px] font-extrabold transition-all flex items-center justify-center gap-1.5 cursor-pointer border border-transparent shadow-md shadow-blue-500/10"
          >
